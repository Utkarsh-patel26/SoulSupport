...
export default function CTASection() {
  return (
    <section className="py-24 sm:py-32 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 dark:from-indigo-950 dark:via-purple-950 dark:to-blue-950 transition-colors duration-500">
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center">
        <motion.div
           ...
           className="bg-white/10 dark:bg-black/20 backdrop-blur-lg border border-white/20 dark:border-white/10 rounded-[3rem] p-12 sm:p-20 shadow-2xl transition-colors duration-300"
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight">
            Your journey to <br />
            <span className="text-purple-200 dark:text-purple-300">peace of mind</span> starts here
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button 
                size="xl"
                className="w-full sm:w-auto bg-white dark:bg-indigo-500 dark:text-white dark:hover:bg-indigo-400 text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 shadow-xl shadow-indigo-900/10 font-bold text-lg px-8 py-6 rounded-2xl transition-all duration-300 transform hover:scale-105"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 text-sm font-medium text-indigo-100 dark:text-indigo-200">
