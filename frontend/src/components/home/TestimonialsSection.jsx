...
const TestimonialCard = ({ testimonial }) => (
  <div className="w-[350px] flex-shrink-0 p-6 mx-4 rounded-3xl bg-surface border border-border shadow-soft hover:shadow-lg transition-all duration-300 group dark:bg-surface-alt">
  ...
  return (
    <section className="py-24 sm:py-32 bg-surface-alt relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] right-[10%] w-96 h-96 bg-purple-100/40 dark:bg-purple-900/20 rounded-full blur-3xl opacity-60" />
        <div className="absolute bottom-[10%] left-[5%] w-72 h-72 bg-blue-100/40 dark:bg-blue-900/20 rounded-full blur-3xl opacity-60" />
      </div>

      <div className="relative z-10 w-full">
        <div className="container mx-auto px-4 max-w-7xl mb-12 sm:mb-16">
          <div className="text-center max-w-2xl mx-auto">
            <span className="inline-block px-4 py-1.5 mb-4 text-xs font-semibold tracking-wider text-orange-900 dark:text-orange-100 uppercase bg-orange-100 dark:bg-orange-900/30 rounded-full">
              Testimonials
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">
              Stories of <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-500 dark:from-purple-400 dark:to-orange-400">transformation</span>
            </h2>
